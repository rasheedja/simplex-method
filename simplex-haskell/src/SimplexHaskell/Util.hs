module SimplexHaskell.Util as Util where

import SimplexHaskell.Simplex as Simplex;
import Prelude;
import Data.Ratio
...
polyConstraintToConstraint pcs =
  case pcs of
    SimplexHaskell.Util.LT vcm r -> Simplex.LT (varConstMapToLinearPoly vcm) r
    SimplexHaskell.Util.GT vcm r -> Simplex.GT (varConstMapToLinearPoly vcm) r
    SimplexHaskell.Util.LEQ vcm r -> Simplex.LEQ (varConstMapToLinearPoly vcm) r
    SimplexHaskell.Util.GEQ vcm r -> Simplex.GEQ (varConstMapToLinearPoly vcm) r
    SimplexHaskell.Util.EQ vcm r -> Simplex.EQ (varConstMapToLinearPoly vcm) r
    SimplexHaskell.Util.LTPP vcm vcm' -> Simplex.LTPP (varConstMapToLinearPoly vcm) (varConstMapToLinearPoly vcm')
    SimplexHaskell.Util.GTPP vcm vcm' -> Simplex.GTPP (varConstMapToLinearPoly vcm) (varConstMapToLinearPoly vcm')
    SimplexHaskell.Util.LEQPP vcm vcm' -> Simplex.LEQPP (varConstMapToLinearPoly vcm) (varConstMapToLinearPoly vcm')
    SimplexHaskell.Util.GEQPP vcm vcm' -> Simplex.GEQPP (varConstMapToLinearPoly vcm) (varConstMapToLinearPoly vcm')
    SimplexHaskell.Util.EQPP vcm vcm' -> Simplex.EQPP (varConstMapToLinearPoly vcm) (varConstMapToLinearPoly vcm')
...
-- TODO: turn varToOptimize into a linearVariableToOptimize (if needed)
